...
src
└── store
    ├── index.ts           # Initializes Vuex, imports modules
    └── modules
        ├── module1.js     # 'module1' namespace
        └── nested
            ├── index.ts   # 'nested' namespace, imports module2 & module3
...
src
└── stores
    ├── index.ts          # (Optional) Initializes Pinia, does not import stores
