    ...
    sidebar: {
      '/api/': [
        {
          ...
          items: [
            ...
            { text: '@pinia/nuxt', link: '/ru/api/modules/pinia_nuxt.html' },
            {
              text: '@pinia/testing',
      ...
      '/': [
        ...
        },
        {
          ...
          items: [
            { text: 'Определение хранилища', link: '/ru/core-concepts/' },
            { text: 'Состояние', link: '/ru/core-concepts/state.html' },
            { text: 'Геттеры', link: '/ru/core-concepts/getters.html' },
            { text: 'Экшены', link: '/ru/core-concepts/actions.html' },
            { text: 'Плагины', link: '/ru/core-concepts/plugins.html' },
            {
              // TODO: Уточнить перевод
              text: 'Хранятся вне компонентов',
