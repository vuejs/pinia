<template>
  <img v-if="!isLoaded" src="/logo.svg" style="z-index: 1;width:100%" />
  <svg v-else viewBox="0 0 408 520" fill="none" xmlns="http://www.w3.org/2000/svg" style="z-index: 1;width:100%"
    ref="svgEl">
    <g class="leaves">
    ...
    <g class="body">
      ...
      <path v-else
        ...
        fill="#E77777" stroke="black" stroke-width="5" />
    </g>
